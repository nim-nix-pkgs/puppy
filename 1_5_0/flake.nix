{
  ...
  inputs.src-puppy-1_5_0.ref   = "refs/tags/1.5.0";
  inputs.src-puppy-1_5_0.owner = "treeform";
  inputs.src-puppy-1_5_0.repo  = "puppy";
  inputs.src-puppy-1_5_0.dir   = "";
  ...
  let 
    ...
    args = ["self" "nixpkgs" "flakeNimbleLib" "src-puppy-1_5_0"];
    over = if builtins.pathExists ./override.nix 
           then { override = import ./override.nix; }
           else { };
  in lib.mkRefOutput (over // {
    inherit self nixpkgs ;
    src  = deps."src-puppy-1_5_0";
